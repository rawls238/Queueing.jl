...
a = SimulationArgs(100000, 0, [QueueNode(props, true, [])])
...
prob = 0.5
a = QueueNode(props, false, [])
b = QueueNode(props, true, [QueueEdge(a, prob)])
jackson_network_args = SimulationArgs(10000, 0, [a, b])
λ_1 = λ * prob
